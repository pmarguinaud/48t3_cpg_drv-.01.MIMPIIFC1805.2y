...
TYPE CPG_FIELD_3D_POINTER_2D_TYPE
...
!>REAL (KIND=JPRB)                      :: QVA_X (NPROMA, 0:NLEV+1)
  ...
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: GHG (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: CHEM (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: AERO (:)
...
!>REAL (KIND=JPRB)                      :: LRCH4_X (NPROMA, 0:NLEV+1)
  ...
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: FORC (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: EZDIAG (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: ERA40 (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: NOGW (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: EDRP (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: SLDIA (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: AERAOT (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: AERLISI (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: AEROUT (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: AEROCLIM (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: UVP (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: PHYS (:)
...
!>REAL (KIND=JPRB)                      :: UNEBH_X (NPROMA, 0:NLEV+1)
  ...
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: CRM (:)
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: LIMA (:)
...
!>REAL (KIND=JPRB)                      :: FSD_X (NPROMA, 0:NLEV+1)
  ...
  TYPE (CPG_FIELD_3D_POINTER_2D_TYPE), ALLOCATABLE :: EXT (:)
CONTAINS
...
WRITE (0, *) __FILE__, ':', __LINE__, " GHG = ", SIZE (YGFL%YGHG)

DO JGFL = 1, SIZE (YGFL%YGHG)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YGHG(JGFL)%MP_SL1, YGFL%YGHG(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " CHEM = ", SIZE (YGFL%YCHEM)

DO JGFL = 1, SIZE (YGFL%YCHEM)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YCHEM(JGFL)%MP_SL1, YGFL%YCHEM(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " AERO = ", SIZE (YGFL%YAERO)

DO JGFL = 1, SIZE (YGFL%YAERO)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YAERO(JGFL)%MP_SL1, YGFL%YAERO(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " FORC = ", SIZE (YGFL%YFORC)

DO JGFL = 1, SIZE (YGFL%YFORC)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YFORC(JGFL)%MP_SL1, YGFL%YFORC(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " EZDIAG = ", SIZE (YGFL%YEZDIAG)

DO JGFL = 1, SIZE (YGFL%YEZDIAG)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YEZDIAG(JGFL)%MP_SL1, YGFL%YEZDIAG(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " ERA40 = ", SIZE (YGFL%YERA40)

DO JGFL = 1, SIZE (YGFL%YERA40)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YERA40(JGFL)%MP_SL1, YGFL%YERA40(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " NOGW = ", SIZE (YGFL%YNOGW)

DO JGFL = 1, SIZE (YGFL%YNOGW)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YNOGW(JGFL)%MP_SL1, YGFL%YNOGW(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " EDRP = ", SIZE (YGFL%YEDRP)

DO JGFL = 1, SIZE (YGFL%YEDRP)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YEDRP(JGFL)%MP_SL1, YGFL%YEDRP(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " SLDIA = ", SIZE (YGFL%YSLDIA)

DO JGFL = 1, SIZE (YGFL%YSLDIA)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YSLDIA(JGFL)%MP_SL1, YGFL%YSLDIA(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " AERAOT = ", SIZE (YGFL%YAERAOT)

DO JGFL = 1, SIZE (YGFL%YAERAOT)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YAERAOT(JGFL)%MP_SL1, YGFL%YAERAOT(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " AERLISI = ", SIZE (YGFL%YAERLISI)

DO JGFL = 1, SIZE (YGFL%YAERLISI)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YAERLISI(JGFL)%MP_SL1, YGFL%YAERLISI(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " AEROUT = ", SIZE (YGFL%YAEROUT)

DO JGFL = 1, SIZE (YGFL%YAEROUT)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YAEROUT(JGFL)%MP_SL1, YGFL%YAEROUT(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " AEROCLIM = ", SIZE (YGFL%YAEROCLIM)

DO JGFL = 1, SIZE (YGFL%YAEROCLIM)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YAEROCLIM(JGFL)%MP_SL1, YGFL%YAEROCLIM(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " UVP = ", SIZE (YGFL%YUVP)

DO JGFL = 1, SIZE (YGFL%YUVP)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YUVP(JGFL)%MP_SL1, YGFL%YUVP(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " PHYS = ", SIZE (YGFL%YPHYS)

DO JGFL = 1, SIZE (YGFL%YPHYS)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YPHYS(JGFL)%MP_SL1, YGFL%YPHYS(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " CRM = ", SIZE (YGFL%YCRM)

DO JGFL = 1, SIZE (YGFL%YCRM)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YCRM(JGFL)%MP_SL1, YGFL%YCRM(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " LIMA = ", SIZE (YGFL%YLIMA)

DO JGFL = 1, SIZE (YGFL%YLIMA)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YLIMA(JGFL)%MP_SL1, YGFL%YLIMA(JGFL)%MP1
...
WRITE (0, *) __FILE__, ':', __LINE__, " EXT = ", SIZE (YGFL%YEXT)

DO JGFL = 1, SIZE (YGFL%YEXT)

WRITE (0, *) __FILE__, ':', __LINE__, JGFL, YGFL%YEXT(JGFL)%MP_SL1, YGFL%YEXT(JGFL)%MP1
