...
CALL CPUTQY0 (.TRUE.,         YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%T,   PDT, YDMF_PHYS_NEXT_STATE%T%P,   PTENDT)
CALL CPUTQY0 (LNHDYN,         YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%SVD, PDT, YDMF_PHYS_NEXT_STATE%SVD%P, PTENDD)
...
CALL CPUTQY0 (YDVARS%H%LT1,   YDCPG_BNDS, YDCPG_OPTS, YDCPG_OPTS%YRVARS_DIMS%H,   PDT, YDMF_PHYS_NEXT_STATE%H%P,   PTENDH)
