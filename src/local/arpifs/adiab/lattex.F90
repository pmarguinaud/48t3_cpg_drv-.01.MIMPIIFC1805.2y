...
IF (YDCPG_OPTS%LTWOTL) THEN
  ...
  CALL LATTEX_DNT(YDCPG_OPTS%NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LLSETTLSW,NWLAG,PESGP,PESGM,&
   ...
   & YDCPG_SL1%U0%P,YDCPG_SL1%U9%P,YDCPG_SL1%UF9%P,YDVARS%CUNL%T9,&
   & PGMVTNDSI(:,:, MSIDDH_U0),PGMVTNDSI(:,:, MSIDDH_U9),YDCPG_SL1%U9_SI%P,&
   & YDCPG_SL1%U9_NL%P)
  
  CALL LATTEX_DNT(YDCPG_OPTS%NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,LLSETTLSW,NWLAG,PESGP,PESGM,&
   & YDVARS%V%T0,YDVARS%V%T9,ZMOY1V,PMIXNL,&
   & YDCPG_SL2%VSI,YDVARS%VNL%T9,YDVARS%V%T1,&
   & YDCPG_SL1%V0%P,YDCPG_SL1%V9%P,YDCPG_SL1%VF9%P,YDVARS%CVNL%T9,&
   & PGMVTNDSI(:,:, MSIDDH_V0),PGMVTNDSI(:,:, MSIDDH_V9),YDCPG_SL1%V9_SI%P,&
   & YDCPG_SL1%V9_NL%P)
...
ELSE
  ...
  CALL LATTEX_TNT(YDGEOMETRY,YDLDDH,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NWLAG,PESGP,PESGM,YDVARS%U%T9,ZMOY1U,ZUSI9,&
   & YDCPG_SL2%USI,YDVARS%U%T1,YDCPG_SL1%U0%P,YDCPG_SL1%U9%P,&
   & YDCPG_SL1%UF9%P,PGMVTNDSI(:,:, MSIDDH_U0),YDCPG_SL1%U9_SI%P)
  CALL LATTEX_TNT(YDGEOMETRY,YDLDDH,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NWLAG,PESGP,PESGM,YDVARS%V%T9,ZMOY1V,ZVSI9,&
   & YDCPG_SL2%VSI,YDVARS%V%T1,YDCPG_SL1%V0%P,YDCPG_SL1%V9%P,&
   & YDCPG_SL1%VF9%P,PGMVTNDSI(:,:, MSIDDH_V0),YDCPG_SL1%V9_SI%P)
...
IF (YDCPG_OPTS%LTWOTL) THEN
  ...
  CALL LATTEX_DNT(YDCPG_OPTS%NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDML_DYN%YRDYNA%LSETTLS,NTLAG,PESGP,PESGM,&
   ...
   & YDCPG_SL1%T0%P,YDCPG_SL1%T9%P,YDCPG_SL1%TF9%P,YDVARS%CTNL%T9,&
   & PGMVTNDSI(:,:, MSIDDH_T0),PGMVTNDSI(:,:, MSIDDH_T9),YDCPG_SL1%T9_SI%P,&
   & YDCPG_SL1%T9_NL%P)
...
ELSE
  ...
  CALL LATTEX_TNT(YDGEOMETRY,YDLDDH,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NTLAG,PESGP,PESGM,YDVARS%T%T9,ZMOY1T,ZTSI9,&
   & YDCPG_SL2%TSI,YDVARS%T%T1,YDCPG_SL1%T0%P,YDCPG_SL1%T9%P,&
   & YDCPG_SL1%TF9%P,PGMVTNDSI(:,:, MSIDDH_T0),YDCPG_SL1%T9_SI%P)
...
DO JLEV=1,NFLEVG
  ...
  IF (.NOT.LLCTC) THEN
    !dir$ ivdep
    DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
      YDCPG_SL1%T9%P(JROF,JLEV)=YDCPG_SL1%T9%P(JROF,JLEV)&
       & +RCORDIF(JLEV)*ZCMSLP*YDOROG%OROG(JROF)
    ENDDO
  ENDIF
ENDDO
...
IF (YDCPG_OPTS%LNHEE) THEN
  ...
  IF (YDCPG_OPTS%LTWOTL) THEN
    ...
    CALL LATTEX_DNT(YDCPG_OPTS%NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDML_DYN%YRDYNA%LSETTLS,NSPDLAG,PESGP,PESGM,&
     ...
     & PGMVTNDSI(:,:, MSIDDH_PD0),PGMVTNDSI(:,:, MSIDDH_PD9),YDCPG_SL1%PD9_SI%P,&
     & YDCPG_SL1%PD9_NL%P)
  ELSE
    ...
    CALL LATTEX_TNT(YDGEOMETRY,YDLDDH,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NSPDLAG,PESGP,PESGM,YDVARS%SPD%T9,&
     & ZMOY1SPD,ZSPDSI9,&
     & YDCPG_SL2%PDSI,YDVARS%SPD%T1,YDCPG_SL1%PD0%P,YDCPG_SL1%PD9%P,&
     & ZUSELESS,PGMVTNDSI(:,:, MSIDDH_PD0),YDCPG_SL1%PD9_SI%P)
  ENDIF
...
IF (YDCPG_OPTS%LNHDYN.AND.(.NOT.YDML_DYN%YRDYNA%LGWADV)) THEN
  ...
  IF (YDCPG_OPTS%LTWOTL) THEN
    ...
    CALL LATTEX_DNT(YDCPG_OPTS%NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDML_DYN%YRDYNA%LSETTLS,NSVDLAG,PESGP,PESGM,&
     ...
     & PGMVTNDSI(:,:, MSIDDH_VD0),PGMVTNDSI(:,:, MSIDDH_VD9),YDCPG_SL1%VD9_SI%P,&
     & YDCPG_SL1%VD9_NL%P)
        ...
        ELSEIF (.NOT.YDML_DYN%YRDYNA%LNESC.AND.(YDCPG_OPTS%NSTEP > NFOST).AND.YDML_DYN%YRDYNA%LSETTLS) THEN
          ...
          DO JLEV=1,NFLEVG
            ...
            DO JROF=YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA
              ...
              YDCPG_SL1%NHX9%P(JROF,JLEV)=PNHXT0(JROF,JLEV)&
               & -YDVARS%NHX%T9(JROF,JLEV)
            ENDDO
          ENDDO
        ELSE
  ...
  ELSE
    ...
    CALL LATTEX_TNT(YDGEOMETRY,YDLDDH,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,NSVDLAG,PESGP,PESGM,YDVARS%SVD%T9,&
     & ZMOY1VWV,ZVWVSI9,&
     & YDCPG_SL2%VDSI,YDVARS%SVD%T1,YDCPG_SL1%VD0%P,YDCPG_SL1%VD9%P,&
     & YDCPG_SL1%VDF9%P,PGMVTNDSI(:,:, MSIDDH_VD0),YDCPG_SL1%VD9_SI%P)
...
IF (YDCPG_OPTS%LNHDYN.AND.YDML_DYN%YRDYNA%LGWADV) THEN
  ...
  IF (YDCPG_OPTS%LTWOTL) THEN
    ...
    IF (YDML_DYN%YRDYNA%NVDVAR == 5) THEN
       ...
       CALL LATTEX_DNT(YDCPG_OPTS%NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDML_DYN%YRDYNA%LSETTLS,NSVDLAG,PESGP,PESGM,&
        ...
        & YDCPG_SL2%VDSI,YDVARS%VWVNL%T9,YDVARS%SVD%T1,&
        & YDCPG_SL1%VD0%P,YDCPG_SL1%VD9%P,YDCPG_SL1%VDF9%P,YDVARS%CVWVNL%T9,&
        & PGMVTNDSI(1,1,MSIDDH_VD0),PGMVTNDSI(1,1,MSIDDH_VD9),YDCPG_SL1%VD9_SI%P,&
        & YDCPG_SL1%VD9_NL%P,LDVD5=LLVD5,PDYT0=ZT0NHY,PDYT9=YDVARS%NHY%T9)
    ELSE
       CALL LATTEX_DNT(YDCPG_OPTS%NSTEP, YDML_DYN%YRDYNA,YDGEOMETRY,YDLDDH,YDRIP,YDDYN,YDCPG_BNDS%KIDIA,YDCPG_BNDS%KFDIA,YDML_DYN%YRDYNA%LSETTLS,NSVDLAG,PESGP,PESGM,&
        & PGWT0,YDVARS%GW%T9,ZMOY1VWV,PMIXNL,&
        & YDCPG_SL2%VDSI,YDVARS%VWVNL%T9,YDVARS%SVD%T1,&
    ...
    IF ((YDML_DYN%YRDYNA%NVDVAR==4 .OR. YDML_DYN%YRDYNA%NVDVAR==5) .AND. YDML_DYN%YRDYNA%ND4SYS==2) THEN
      IF (.NOT.LLCT) THEN
        DO JLEV=1,NFLEVG
          YDCPG_SL1%NHX9%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=PNHXT0(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)
        ENDDO
      ...
      ELSE
        DO JLEV=1,NFLEVG
          YDCPG_SL1%NHX9%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=YDVARS%NHX%T9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)
        ENDDO
      ENDIF
    ENDIF
  ...
  ELSE
    ...
    IF ((YDML_DYN%YRDYNA%NVDVAR==4 .OR. YDML_DYN%YRDYNA%NVDVAR==5) .AND. YDML_DYN%YRDYNA%ND4SYS==2) THEN
      DO JLEV=1,NFLEVG
        YDCPG_SL1%NHX9%P(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)=PNHXT9(YDCPG_BNDS%KIDIA:YDCPG_BNDS%KFDIA,JLEV)
      ENDDO
    ENDIF
