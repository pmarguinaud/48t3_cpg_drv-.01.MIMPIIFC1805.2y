...
& PEMTU, PTRSW, PRMOON, PGMVTNDSI_DDH, YDTRC, PB1, PB2, PGMVT1,   &
...
CALL YLMF_PHYS%OPT%INIT (YDFIELDS%REGISTRY, YDCPG_OPTS=YLCPG_OPTS, LDMF_PHYS=LMPHYS.OR.LSIMPH, PGDEOSI=YDTRC%GDEOSI,      &
& PGUEOSI=YDTRC%GUEOSI, PGMU0=YDTRC%GMU0, PGMU0_MIN=YDTRC%GMU0_MIN, PGMU0_MAX=YDTRC%GMU0_MAX, PGDEOTI=YDTRC%GDEOTI, PGDEOTI2=YDTRC%GDEOTI2,        &
& PGUEOTI=YDTRC%GUEOTI, PGUEOTI2=YDTRC%GUEOTI2, PGEOLT=YDTRC%GEOLT, PGEOXT=YDTRC%GEOXT, PGRPROX=YDTRC%GRPROX, PGMIXP=YDTRC%GMIXP, PGFLUXC=YDTRC%GFLUXC, &
& PGRSURF=YDTRC%GRSURF, PERSISTENT=LLPERSISTENT)
