...
!WRITE (0, *) "CPG_SL1_TYPE_INIT_F3D ", JFLD, TRIM(YDGFC%CNAME)//"P_F"
...
!WRITE (0, *) "CPG_SL1_TYPE_INIT_F3D ", JFLD, TRIM(YDGFC%CNAME)//"P_SPF"
...
!WRITE (0, *) "CPG_SL1_TYPE_INIT_F3D ", JFLD, TRIM(YDGFC%CNAME)//"P_SP"
...
!WRITE (0, *) "CPG_SL1_TYPE_INIT_F3D ", JFLD, TRIM(YDGFC%CNAME)//"P_P"
  YDF3D%F_P_P => CREATE_FIELD_WRAP (SELF%ZDATA (:, JFLD:JFLD+NLEV+1, :), PERSISTENT=LLPERSISTENT, LBOUNDS=[1,0,1])
ELSE
  YDF3D%F_P_P => NULL ()
ENDIF

IF (YDGFC%MP_SLX >= 0) THEN
  JFLD = ISLB1GFL9  + YDGFC%MP_SLX
!WRITE (0, *) "CPG_SL1_TYPE_INIT_F3D ", JFLD, TRIM(YDGFC%CNAME)//"P_X"
