...
!=SKIP
    ...
    & YDCPG_MISC, YDCPG_GPAR, YDCPG_PHY0, YDMF_PHYS, YDCPG_DYN0, &
...
!     assumed to be zero and it is ignored.
  ...
  CALL CPG_PT_ULP_EXPL(YDMODEL, YDGEOMETRY, YLMF_PHYS_NEXT_STATE, YDCPG_SL1, YDVARS, YDCPG_BNDS, LLGET, PGFLPT)
