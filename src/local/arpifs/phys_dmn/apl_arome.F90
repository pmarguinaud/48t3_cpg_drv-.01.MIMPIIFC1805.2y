...
IF (LMICRO) THEN
  ...
  ELSE
    ...
    & CFRAC_ICE_ADJUST, LOSUBG_COND, LOSIGMAS, CMICRO, LOCND2, LHGT_QS, ZDT, VSIGQSAT, ZZZ_F_, ZRHODJM__(:, 1:YDCPG_OPTS%KFLEVG), &
...
IF (LMICRO) THEN
  ...
  ELSE
    ...
    & NSPLITR, LOSUBG_COND, CSUBG_AUCV_RC, LOSEDIC, CSEDIM, CMICRO, ZDT, ZDZZ_, ZRHODJM__(:, 1:YDCPG_OPTS%KFLEVG),              &
    & ZRHODREFM__(:, 1:YDCPG_OPTS%KFLEVG), ZEXNREFM_, ZPABSM__(:, 1:YDCPG_OPTS%KFLEVG), ZTHM__(:, 1:YDCPG_OPTS%KFLEVG),         &
...
IF(LNHDYN) THEN
  ...
  ELSE
    ...
    ! * Do conversion:
    CALL GNHGW2SVDAROME(YDGEOMETRY, YDCPG_BNDS%KIDIA, YDCPG_BNDS%KFDIA, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREHYDF, &
                      & YDMF_PHYS_BASE_STATE%YCPG_PHY%XYB%LNPR, ZRTT1, YDMF_PHYS_BASE_STATE%YCPG_PHY%PREF,     &
                      & ZGWT1, ZTENDD)  
